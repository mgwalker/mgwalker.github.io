...
CMS picked five states for us to partner with. The goal was fairly simple:
...
get started. So you have to look around until you find something that looks
small enough not to be too disruptive. Find a small thing that everything else
depends on but which does not depend on anything else, or the other way around.
The smallest pond, where tossing in a pebble produces the fewest ripples. And
you toss your pebbles into that pond.
